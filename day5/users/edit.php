...
<div class="container">
    <form action="index.php?module=user&action=create" method="post">
        ...
        <div class="col-sm-9">
            <input type="text" id="fullname" name="fullname" class="form-control <?= $fullNameErr ? 'border-danger' : ''?>" value="<?= $user['fullname']?>"/>
        ...
        <div class="col-sm-9">
            <input type="text" id="email" name="email" class="form-control  <?= $emailErr ? 'border-danger' : ''?>" value="<?= $user['email']?>"   />
        ...
        <div class="col-sm-9">
            <input type="text" id="phone" name="phone" class="form-control <?= $phoneErr ? 'border-danger' : ''?>" value="<?= $user['phone']?>"/>
        ...
        <div class="col-sm-9">
            <input type="text" id="address" name="address" class="form-control <?= $addressErr ? 'border-danger' : ''?>" value="<?= $user['address']?>"/>
        ...
        <div class="col-sm-9">
            <label><input type="radio" id="male" name="gender" value="1" <?=$user['gender'] == 1 ? 'checked' : ''?>/> Nam</label>
